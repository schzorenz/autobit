  ...
  return (
    ...
    >
      ...
      <div
        style={{
          ...
          backgroundImage: [
            ...
            "radial-gradient(ellipse 40% 30% at 30% 60%, rgba(255,255,255,0.03), transparent)",
            "radial-gradient(ellipse 40% 30% at 70% 30%, rgba(255,255,255,0.03), transparent)",
          ].join(", "),
          pointerEvents: "none",
        }}
      />
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          <span style={{ height: "6px", width: "6px", borderRadius: "50%", background: "rgba(255,255,255,0.4)" }} className="animate-pulse" />
          Start Something™
        </a>
        ...
        >
          ...
          <span style={{ display: "inline-block", position: "relative", minWidth: "200px", verticalAlign: "bottom", overflow: "hidden", height: "1.1em" }}>
        ...
        <p style={{
          ...
          textAlign: "center", maxWidth: "520px", margin: "20px auto 0", lineHeight: 1.5, letterSpacing: "-0.01em",
        }}>
        ...
        <div style={{ display: "flex", gap: "12px", justifyContent: "center", marginTop: "32px" }}>
          <a href="mailto:autobitofficial.ph@gmail.com" style={{
            background: "#2997ff", color: "#ffffff", padding: "12px 28px", borderRadius: "980px",
            fontSize: "15px", fontWeight: 600, textDecoration: "none", transition: "all 0.2s ease",
            fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', sans-serif", cursor: "pointer",
          }}
            onMouseEnter={(e) => { e.currentTarget.style.opacity = "0.9"; }}
            onMouseLeave={(e) => { e.currentTarget.style.opacity = "1"; }}
          >Start a project</a>
          <a href="/projects" style={{
            background: "transparent", color: "#2997ff", padding: "12px 28px", borderRadius: "980px",
            fontSize: "15px", fontWeight: 600, textDecoration: "none", transition: "all 0.2s ease",
            fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', sans-serif", cursor: "pointer",
          }}
            onMouseEnter={(e) => { e.currentTarget.style.color = "rgba(41,151,255,0.8)"; }}
            onMouseLeave={(e) => { e.currentTarget.style.color = "#2997ff"; }}
          >See our work →</a>
        </div>

        {/* Trust line */}
        <p style={{ fontSize: "12px", color: "rgba(255,255,255,0.25)", textAlign: "center", marginTop: "20px", letterSpacing: "0.01em" }}>
